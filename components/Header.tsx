        ...
        {isMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-2">
              {/* About Us */}
              <div>
                <div className="font-semibold text-gray-900 py-2 px-2">About Us</div>
                <div className="pl-4 flex flex-col gap-1">
                  <a
                    href="https://crackersstudio.com/business"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-700 hover:text-gray-900 py-2 px-2 transition-colors"
              ...
              {/* Brand */}
              <div>
                <div className="font-semibold text-gray-900 py-2 px-2">Brand</div>
                <div className="pl-4">
                  <div className="font-medium text-gray-800 py-2 px-2">Little Crack</div>
                  <div className="pl-4 flex flex-col gap-1">
                    <a
                      href="https://crackersstudio.com/characters"
                      target="_blank"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="font-semibold text-gray-900 py-2 px-2"
              >
                Shop
              </a>
